...
type Querier interface {
	CountScenesForAdmin(ctx context.Context, db DBTX) (int64, error)
	DeleteMusic(ctx context.Context, db DBTX, id int64) error
	DeletePhotograph(ctx context.Context, db DBTX, id int64) error
	DeleteScene(ctx context.Context, db DBTX, id int64) error
	...
	GetMusicById(ctx context.Context, db DBTX, id int64) (Music, error)
	...
	GetPhotographListForAdmin(ctx context.Context, db DBTX) ([]GetPhotographListForAdminRow, error)
	...
	GetProducerWithAdmin(ctx context.Context, db DBTX, identityID string) (Producer, error)
	GetSceneById(ctx context.Context, db DBTX, id int64) (GetSceneByIdRow, error)
	GetSceneListForAdmin(ctx context.Context, db DBTX, arg GetSceneListForAdminParams) ([]GetSceneListForAdminRow, error)
	...
	UpdateScene(ctx context.Context, db DBTX, arg UpdateSceneParams) error
}
